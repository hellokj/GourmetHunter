...
//        System.out.println(collisionDirP1 + "," + collisionDirP2);
    ...
    public void paint(Graphics g, MainPanel mainPanel) {
        ...
        if (isDark){
            g2d.setClip(new Ellipse2D.Float(player2.getCenterPoint().x - 75, player2.getCenterPoint().y - 75, 150, 150));
            g2d2.setClip(new Ellipse2D.Float(player1.getCenterPoint().x - 75, player1.getCenterPoint().y - 75, 150, 150));
        }
        for (Floor floor : floors) {
